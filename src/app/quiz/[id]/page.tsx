...
export default function QuizPage() {
  ...
  if (isLoading) {
    return (
      <>
        <DynamicMetaTags
          title="Loading Quiz - Veggie Quiz"
          description="Loading your quiz..."
        />
  ...
  return (
    <>
      <DynamicMetaTags
        ...
        ogTitle={`${quiz.name} - Veggie Quiz`}
        ogDescription={quiz.description}
        ogImage={quiz.image}
        twitterTitle={`${quiz.name} - Veggie Quiz`}
        twitterDescription={quiz.description}
